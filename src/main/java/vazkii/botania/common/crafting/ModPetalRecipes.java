...
public final class ModPetalRecipes {
	...
	public static final String runeWater = LibOreDict.RUNE[3], runeFire = LibOreDict.RUNE[2], runeEarth = LibOreDict.RUNE[4], runeAir = LibOreDict.RUNE[1], runeSpring = LibOreDict.RUNE[8], runeSummer = LibOreDict.RUNE[9], runeAutumn = LibOreDict.RUNE[10], runeWinter = LibOreDict.RUNE[11], runeMana = LibOreDict.RUNE[7], runeLust = LibOreDict.RUNE[12], runeGluttony = LibOreDict.RUNE[13], runeGreed = LibOreDict.RUNE[14], runeSloth = LibOreDict.RUNE[15], runeWrath = LibOreDict.RUNE[16], runeEnvy = LibOreDict.RUNE[17], runePride = LibOreDict.RUNE[18];
